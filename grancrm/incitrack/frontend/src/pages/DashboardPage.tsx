      ...
      <div className="main-content">
        ...
        {stats && (() => {
          ...
          <>
            ...
            {/* Tickets recientes (Tabs) */}
            <div className="card stretch stretch-full">
              <div className="card-header p-0 d-flex justify-content-between align-items-end flex-wrap" style={{ borderBottom: '1px solid var(--bs-border-color)' }}>
                <ul className="nav nav-tabs nav-tabs-custom border-bottom-0 mb-0 px-2" style={{ marginBottom: '-1px' }}>
              ...
              <div className="card-body p-0" style={{ scrollbarGutter: 'stable' }}>
                {activeTab === 'auditoria' ? (
                  <div className="p-4">
                    {stats.auditoria_reciente.length === 0 ? (
                      ...
                      <div className="d-flex flex-column gap-3">
                        {stats.auditoria_reciente.map(a => (
                          <div key={a.id} className="d-flex gap-3 p-3 rounded border" style={{ background: 'var(--bs-tertiary-bg)' }}>
                            <div className="avatar-ini mt-1">{a.autor_nombre.slice(0, 2).toUpperCase()}</div>
                            <div>
                              <div className="fs-13">
