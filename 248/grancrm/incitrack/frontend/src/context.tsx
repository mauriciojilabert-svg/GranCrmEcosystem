...
// para que los gates (`=== 'sa'`, `['sa','admin']`) sigan funcionando con
// JWT_ROLES_COMPAT en True o False. Se aplica una sola vez en el provider (App.tsx).
export function normalizeRole(rol: string): string {
  ...
  return rol; // ejecutivo / vacío / desconocido → sin cambios
}
