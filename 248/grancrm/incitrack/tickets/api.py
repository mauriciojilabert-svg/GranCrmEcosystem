...
def ticket_detail(request: HttpRequest, ticket_id: int):
    ...
    return 200, TicketOut(
        ...
        cuenta_nombre=ticket.cuenta.nombre if ticket.cuenta_id else None,
        creado_por_id=ticket.creado_por_id,
        creado_por_nombre=ticket.creado_por.nombre if ticket.creado_por_id else None,
        asignado_a_id=ticket.asignado_a_id,
        asignado_a_nombre=ticket.asignado_a.nombre if ticket.asignado_a_id else None,
        categoria_id=ticket.categoria_id,
        categoria_nombre=ticket.categoria.nombre if ticket.categoria_id else None,
        subcategoria_id=ticket.subcategoria_id,
        subcategoria_nombre=ticket.subcategoria.nombre if ticket.subcategoria_id else None,
...
def ticket_create(request: HttpRequest, data: TicketCreateIn):
    ...
    return 201, TicketOut(
        ...
        fue_reasignado=ticket.fue_reasignado,
        cuenta_id=ticket.cuenta_id,
        cuenta_nombre=ticket.cuenta.nombre,
        creado_por_id=ticket.creado_por_id,
        creado_por_nombre=ticket.creado_por.nombre,
        asignado_a_id=ticket.asignado_a_id,
        asignado_a_nombre=ticket.asignado_a.nombre if ticket.asignado_a_id else None,
        categoria_id=ticket.categoria_id,
...
def sla_list(request: HttpRequest):
    ...
    return 200, [
        SLAOut(
            ...
            categoria_nombre=s.categoria.nombre if s.categoria_id else None,
            subcategoria_id=s.subcategoria_id,
            subcategoria_nombre=s.subcategoria.nombre if s.subcategoria_id else None,
